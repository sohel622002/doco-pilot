...
// ws/index.js pulls in repositories that import the supabase client —
// mock it so this suite can import the module (and its action-allowlist
// Sets) without real credentials.
...
let ALLOWED_ACTIONS: any, VIEWER_ALLOWED_ACTIONS: any, EXEC_STREAM_ACTIONS: any
