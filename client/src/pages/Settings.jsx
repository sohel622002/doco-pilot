...
function ProfileCard() {
  ...
  return (
    <section className="bg-surface-container-lowest border border-outline-variant rounded-xl p-md mb-md">
      ...
      <form onSubmit={onSubmit} className="space-y-sm max-w-md">
        <div className="space-y-xs">
          <label className="font-body-main font-semibold block">Full Name</label>
          <input
            type="text"
            required
            className="w-full bg-surface-container-low border border-outline-variant rounded px-sm py-xs text-body-main focus:ring-1 focus:ring-primary focus:outline-none"
            value={name}
        ...
        <div className="space-y-xs">
          ...
          <input
            type="email"
            disabled
            className="w-full bg-surface-container-high border border-outline-variant rounded px-sm py-xs text-body-main text-on-surface-variant cursor-not-allowed"
            value={email}
          />
          {!emailVerified && (
            <div className="flex items-center gap-sm text-label-caps text-error">
...
export default function Settings() {
  return (
    <div className="max-w-container-max mx-auto p-md">
      <div className="max-w-container-max mx-auto">
        ...
        <ProfileCard />
        <ChangePasswordCard />
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-md items-start">
          ...
          <section className="bg-surface-container-lowest border border-outline-variant rounded-xl p-md">
            ...
            <div className="space-y-md">
              ...
              <div className="space-y-sm">
                ...
                <div className="bg-surface-container-high rounded p-sm font-code text-code text-on-surface border border-outline-variant/50">
                  <pre>{`{
  ...
  "storage-driver": "overlay2"
              ...
              <div className="flex justify-end gap-sm pt-md">
                <button className="px-md py-xs rounded border border-outline-variant text-on-surface font-body-main hover:bg-surface-container-high transition-colors">
                  Discard
                </button>
                <button className="px-md py-xs rounded bg-primary text-on-primary font-body-main hover:opacity-90 transition-opacity">
                  Apply Changes
                </button>
              </div>
            </div>
          ...
          {/* <!-- System Logs Section --> */}
          <section className="bg-inverse-surface rounded-xl p-md flex flex-col h-full">
            <div className="flex items-center justify-between mb-md border-b border-surface-variant/20 pb-sm">
            ...
            <div className="flex-1 overflow-y-auto font-code text-code space-y-xs pr-xs scrollbar-thin">
              ...
              <div className="flex gap-md border-l-2 border-primary pl-xs py-xs bg-surface-variant/10">
            ...
            <div className="mt-md pt-sm border-t border-surface-variant/20 flex items-center justify-between">
              <div className="flex items-center gap-md">
                <button className="text-surface-variant hover:text-inverse-on-surface transition-colors flex items-center gap-xs">
              ...
              <div className="flex items-center gap-xs bg-surface-variant/10 px-sm py-1 rounded border border-surface-variant/20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-md mt-md">
          <div className="bg-surface-container border border-outline-variant rounded-xl p-md flex items-center justify-between">
            <div>
