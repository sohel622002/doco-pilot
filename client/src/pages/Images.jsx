  ...
  return (
    <div className="max-w-container-max mx-auto p-md">
      ...
      <div className="flex items-center justify-between mb-md">
        ...
        <form onSubmit={handlePull} className="flex items-center gap-xs">
          <input
            className="px-sm py-xs bg-surface-container-low border border-outline-variant rounded-lg font-code text-code text-on-surface"
          ...
          <button
            type="submit"
            disabled={pulling}
            className="flex items-center gap-xs bg-primary text-on-primary px-md py-xs rounded-lg font-body-main font-bold hover:opacity-90 transition-opacity disabled:opacity-50"
          >
            <Download size={16} />
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-md mb-md">
        <div className="p-sm bg-surface border border-outline-variant rounded-xl flex flex-col gap-xs">
          <span className="text-on-surface-variant font-label-caps uppercase tracking-wider font-bold text-xs">
            Total Images
          </span>
          <div className="flex items-end gap-sm">
            <span className="text-h1 font-h1">{images?.length ?? 0}</span>
        ...
        <div className="p-sm bg-surface border border-outline-variant rounded-xl flex flex-col gap-xs">
          ...
          <div className="flex items-end gap-sm">
            <span className="text-h1 font-h1">12.4 GB</span>
        ...
        <div className="p-sm bg-surface border border-outline-variant rounded-xl flex flex-col gap-xs">
          ...
          <div className="flex items-end gap-sm">
            <span className="text-h1 font-h1">8</span>
        ...
        <div className="p-sm bg-surface border border-outline-variant rounded-xl flex flex-col gap-xs">
          ...
          <div className="flex items-end gap-sm">
            <span className="text-h1 font-h1">Active</span>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-surface-container-low border-b border-outline-variant">
                <th className="px-md py-sm font-label-caps text-on-surface-variant">
                  Repository Name
                </th>
                <th className="px-md py-sm font-label-caps text-on-surface-variant">
                  Tag
                ...
                <th className="px-md py-sm font-label-caps text-on-surface-variant text-right">
                  Actions
                </th>
              </tr>
            </thead>
              ...
              {images &&
                images.map((image) => (
                  <tr className="hover:bg-surface-container-lowest transition-colors group" key={image?.id}>
                    ...
                    <td className="px-md py-sm">
                      <span className="px-xs py-0.5 bg-secondary-container text-on-secondary-container rounded font-code text-xs">
                    ...
                    <td className="px-md py-sm text-on-surface">{formatBytes(image?.size)}</td>
      ...
      <div className="mt-md grid grid-cols-1 md:grid-cols-3 gap-md">
        <div className="md:col-span-2 p-md bg-surface border border-outline-variant rounded-xl">
          ...
          <div className="space-y-sm">
            <div className="flex items-start gap-sm p-sm bg-surface-container-low hover:bg-surface-container rounded-lg transition-colors border border-transparent hover:border-outline-variant">
              <span
                className="material-symbols-outlined text-primary bg-primary-fixed p-xs rounded"
            ...
            <div className="flex items-start gap-sm p-sm bg-surface-container-low hover:bg-surface-container rounded-lg transition-colors border border-transparent hover:border-outline-variant">
              <span
                className="material-symbols-outlined text-error bg-error-container p-xs rounded"
                data-icon="warning"
              >
                warning
              </span>
        ...
        <div className="p-0 bg-surface border border-outline-variant rounded-xl overflow-hidden flex flex-col">
          <div className="p-md flex-1">
            ...
            <p className="text-on-surface-variant text-xs mb-md">
            ...
            <div className="flex items-center justify-center py-md">
              <div className="relative w-32 h-32 flex items-center justify-center">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                  <span className="text-h1 font-h1">80%</span>
          ...
          <div className="p-sm bg-surface-container-low border-t border-outline-variant flex items-center justify-between">
